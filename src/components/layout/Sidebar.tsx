...
export function Sidebar() {
  ...
  const { generate, enhance, isGenerating, steps: genSteps } = useGenerate();
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin px-4 py-4 flex flex-col gap-4">
        ...
        {project && (
          <div className="rounded-lg border border-[var(--border)] bg-[var(--surface)] p-3 space-y-2">
            ...
            />
            <Button
              className="w-full py-2 bg-violet/80 hover:bg-violet text-white text-xs font-medium disabled:opacity-50"
              disabled={!canEnhance}
